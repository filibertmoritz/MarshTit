...
source("scripts/MarshTit_modelling_prep_occ_data_all_birds_skane.R")

# step 4: get environmental variables (LiDAR, NMD land use, NMD moisture) for occurence locations but also across the study area for prediction
source("scripts/MarshTit_modelling_prep_envCovs.R") # for occurrence locations, and model training
source("scripts/MarshTit_modelling_get_LiDAR_data.R") #  whole study area, for sdm map prediction

# step 5: model species distribution and visualisations
source("scripts/MarshTit_modelling_built_model.R")
# source("scripts/MarshTit_modelling_built_model_effort.R") # for the model with effort...
